...
from simulation.network.MAPPO import MAPPO
from simulation.cyber_space.DigitalTwinMutiAgentEnv import DummyMultiAgentEnv
import wandb
...
def main():
    ...
    if offload_model == "MAPPO":
        wandb.run.name = f"group_name_{data_set}_lam{task_arrival_rate}_{offload_model}"
        if byzantine_attack:
...
"""
export PYTHONPATH=$PYTHONPATH:/home/power/WangChen/Digital-Twin-Byzantine
cd /home/power/WangChen/Digital-Twin-Byzantine
/home/power/anaconda3/envs/pytorch/bin/python -u simulation/main.py
